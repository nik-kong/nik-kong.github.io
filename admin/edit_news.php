                    	...
                    	<div class="span8">
                           <br>
                            ...
                            <div class="contact_form">  
                                ...
                                <div id="fields">
                                 <?php
$result = mysql_query("SELECT * FROM news WHERE id='$id'",$link);
...
do
{
    ...
    echo '
                                    <form id="ajax-contact-form" method="post" align="center" action="handler_edit_news.php?id='.$row["id"].'">
                                      <p id="reg_message"></p>
                                       <div id="block-form-registration">
                                        <input class="span5" type="text" name="title" value="'.$row["title"].'" placeholder="Название" />
                                        <input class="span5" type="text" name="image" value="'.$row["image"].'" placeholder="Картинка" />
                                           <h5 class="h3click" >Краткое описание</h5>
                                            <div class="div-editor1" >
                                                 <textarea id="editor1" name="editor1" cols="20" rows="100">'.$row["description"].'</textarea>
                                        ...
                                        <h5 class="h3click" >Текст статьи</h5>
                                            <div class="div-editor2" >
                                                    <textarea id="editor2" name="editor2" cols="20" rows="80">'.$row["text"].'</textarea>
		                                            <script type="text/javascript">
                        ...
                        success: function (data) {
                            ...
                            if (data == 'true') {
                                $("#block-form-registration").fadeOut(300, function () {
                                    $("#reg_message").addClass("reg_message_good").fadeIn(400).html("Новость изменена!");
                                    $("#form_submit").hide();
                                });
                            } else {
